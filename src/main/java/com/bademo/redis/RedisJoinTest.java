...
public class RedisJoinTest{
    ...
    public void testMap() {
        ...
        System.out.println(jedis.hgetAll("user"));//返回所有的键值对
    }
    ...
    public void testList() {
        ...
        System.out.println(jedis.lrange("java framework", 0, -1));
        jedis.del("java framework");
        jedis.rpush("java framework", "spring", "struts", "hibernate");
        System.out.println(jedis.lrange("java framework", 0, -1));
        jedis.del("java framework");
    }
    ...
    public void testSet() {
        //add
        jedis.sadd("user", "liuling", "xinxin", "ling", "zhangxinxin", "who");
        jedis.srem("user", "who"); //移除元素
